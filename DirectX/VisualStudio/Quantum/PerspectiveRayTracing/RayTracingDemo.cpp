...
const unsigned int RayTracingDemo::NUM_SPHERE = 2;
...
void RayTracingDemo::initialize()
{
	...
	mEffect->LoadCompiledEffect(L"PerspectiveRayTraceEffect.cso");
	...
	{
		XMFLOAT3 position(150.0f * i,150.0f * i , 200.0f + (i * 10.0f) );
