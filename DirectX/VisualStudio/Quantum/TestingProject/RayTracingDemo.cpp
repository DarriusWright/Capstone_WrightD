...
float const RayTracingDemo::MAX_POSITION = 20.0f;
float const RayTracingDemo::MIN_POSITION = -20.0f;
...
mBlueColor(1.0f), mPosition(0, 0, 0), mLightPosition(0, 0, -5), mCamera(new SimpleCamera(game,200.0f))
{
}
...
void RayTracingDemo::initialize()
{
	...
	mEffect->LoadCompiledEffect(L"TestingRayTrace.cso");
