...
const unsigned int RayTracingDemo::NUM_SPHERE = 5;
...
void RayTracingDemo::initialize()
{
	...
	mEffect->LoadCompiledEffect(L"DepthRayTraceEffect.cso");
	...
	{
		XMFLOAT3 position(getRandomFloat(MIN_POSITION, MAX_POSITION), getRandomFloat(MIN_POSITION, MAX_POSITION), getRandomFloat(-2.0f * MAX_POSITION,0));
